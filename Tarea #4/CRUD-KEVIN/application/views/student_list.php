...
<table class="table">
            ...
            <tbody>
                ...
                <td class="text-right">
                    ...
                    <a href="<?php echo 'delete-student-info'.'/'.$value['student_id'];?>"    class="button button-red" >Delete</a> 
                  
                    <a href="<?php echo 'update-student-info'.'/'.$value['student_id'];?>"   class="button button-blue" >Edit</a> 
                  
                    <a  href="<?php echo 'view-student-info'.'/'.$value['student_id'];?>"   class="button button-green" >View</a> 
